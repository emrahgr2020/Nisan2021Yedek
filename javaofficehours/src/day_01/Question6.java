...
public class Question6 {
	...
	public static void main(String[] args) {
		 ...
		 * 1) \\d ==> tum rakamlar \\D ==> tum rakam disi character ler 2) \\w ==> A->Z
		 * a->z 0->9 _ \\W ==> A->Z a->z 0->9 _ disindaki hersey 3) \\s ==> space \\S
		 * ==> space disindaki hersey
		 */
		...
		System.out.println("Lutfen kredi karti numarinizi giriniz");
